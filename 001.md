...
Luckily the Italian government puts a great deal of data about the COVID-19 epidemics on [Github](https://github.com/pcm-dpc/COVID-19), so I went on, downloaded the whole treasure trove, and started writing some code.
